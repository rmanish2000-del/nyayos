...
import { t as createCsrfMiddleware } from "./createCsrfMiddleware-FjlsSeT-.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-KXfVjzfY.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B8C9iAMe.mjs"),
		import("./start-Dmjhauxw.mjs"),
		import("./empty-plugin-adapters-Dq-X_n2v.mjs")
	]);
	return {
		routerEntry,
		startEntry,
